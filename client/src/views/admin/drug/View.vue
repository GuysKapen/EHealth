                  ...
                  >
                    <table class="min-w-full divide-y divide-gray-200">
                      ...
                      <tbody class="bg-white divide-y divide-gray-200">
                        <tr v-for="(drug, idx) in drugs" :key="idx">
                          ...
                          <td class="text-sm text-center text-gray-500 px-6">
                            {{ drug.description }}
                          </td>
                          <td
  ...
  methods: {
    deleteModel(id) {
      ...
      showConfirmPopup(function () {
        const authStore = useAuthStore();
        axios
          .delete(`${serverUrl}/admin/drugs/${id}`, {
            headers: {
              "Content-Type": "application/json",
              Authorization: `Bearer ${authStore.token}`,
              "x-access-token": authStore.token,
          ...
          .then(function () {
            self.drugs = self.drugs.filter((item) => item._id !== id);
            createToast("Success delete drug", { type: "success" });
          });
      });
    },
  },
