        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="card mt-8 shadow-lg rounded-md p-8">
            <div class="flex justify-between">
              ...
              <router-link
                :to="{ name: 'provisional-diagnose-new' }"
                  ...
                  >
                    <table class="min-w-full divide-y divide-gray-200">
                      ...
                      <tbody class="bg-white divide-y divide-gray-200">
                        <tr v-for="(PD, idx) in PDs" :key="idx">
...
export default {
  mounted() {
    ...
    axios
      .get(`${serverUrl}/admin/provisional-diagnosis`, {
        headers: {
  ...
  methods: {
    deleteModel(id) {
      ...
      showConfirmPopup(function () {
        const authStore = useAuthStore();
        axios
          .delete(`${serverUrl}/admin/provisional-diagnoses/${id}`, {
            headers: {
              "Content-Type": "application/json",
              Authorization: `Bearer ${authStore.token}`,
              "x-access-token": authStore.token,
          ...
          .then(function () {
            self.PDs = self.PDs.filter((item) => item._id !== id);
            createToast("Success delete PD", { type: "success" });
          });
      });
    },
  },
