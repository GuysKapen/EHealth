        ...
        <div class="grid grid-cols-6 gap-6">
          ...
          <div class="col-span-6 sm:col-span-6 lg:col-span-2">
            ...
            <input
              ...
              name="city"
              id="city"
              v-model="newModel.city"
              autocomplete="address-level2"
              class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm bg-gray-100 focus:bg-white border-gray-300 rounded-md"
            />
          </div>
