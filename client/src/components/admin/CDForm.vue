          ...
          <div class="field">
            <div class="control">
              ...
              <input
                ...
                type="text"
                autofocus
                placeholder="Clinical diagnose name..."
              />
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    async add(newModel) {
      ...
      try {
        axios
          .post(`${serverUrl}/admin/clinical-diagnosis`, newModel, {
            headers: {
          ...
          .then(() => {
            ...
            this.$router.push({ name: "clinical-diagnose-index" });
          });
      } catch (error) {
    ...
    async update(id, newModel) {
      ...
      try {
        axios
          .put(`${serverUrl}/admin/clinical-diagnosis/${id}`, newModel, {
            headers: {
              "Content-Type": "application/json",
              Authorization: `Bearer ${authStore.token}`,
              "x-access-token": authStore.token,
