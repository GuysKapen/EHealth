          ...
          <div class="field">
            <div class="control">
              ...
              <input
                ...
                type="text"
                autofocus
                placeholder="Chief complaint name..."
              />
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    async add(newModel) {
      ...
      try {
        axios
          .post(`${serverUrl}/admin/chief-complaint`, newModel, {
            headers: {
          ...
          .then(() => {
            ...
            this.$router.push({ name: "chief-complaint-index" });
          });
      } catch (error) {
    ...
    async update(id, newModel) {
      ...
      try {
        axios
          .put(`${serverUrl}/admin/chief-complaint/${id}`, newModel, {
            headers: {
              "Content-Type": "application/json",
              Authorization: `Bearer ${authStore.token}`,
              "x-access-token": authStore.token,
