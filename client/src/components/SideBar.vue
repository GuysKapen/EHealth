        ...
        <div class="mt-4 space-y-6">
          <div class="flex items-start tab-panel active">
            <router-link to="/" class="flex items-start">
              <div
                class="bg-white rounded-lg flex items-center justify-center ml-4 w-6 h-6 flex-shrink-0 border border-gray-100"
              >
          ...
          <div class="flex items-start tab-panel">
            <router-link to="/doctors" class="flex items-start">
              <div
                class="bg-white rounded-lg flex items-center justify-center ml-4 w-6 h-6 flex-shrink-0 border border-gray-100"
              >
      ...
      <div class="px-4 py-5 space-y-6 sm:p-6">
        ...
        <div class="mt-4 space-y-6">
          <div
            ...
            v-for="(obj, idx) in categories"
            :key="idx"
          >
            <router-link
              :to="{
                name: 'home',
                query: { category: obj.category?.slug ?? 'uncategorized' },
              }"
            >
